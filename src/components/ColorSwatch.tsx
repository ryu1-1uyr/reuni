      ...
      >
        {onDelete && (
          <button
            ...
            className={`absolute top-1 right-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-black/30 ${textOnSwatch} text-xs leading-none opacity-0 pointer-coarse:opacity-70 group-hover:opacity-100 transition-opacity hover:bg-black/50 text-white`}
          >
            ×
          </button>
        )}
